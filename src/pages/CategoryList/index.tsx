import { getCategoryData, addCategory, updateCategory, deleteCategory } from '@/services/aikb/api';
import { Form, Modal, Button, Tree, Input, message } from 'antd';
...
const CategoryList: React.FC = () => {
	...
	return (
		<div className="category-page">
			...
			<Modal title={actionType === 'add' ? '增加类目' : '修改类目'} open={categoryModalShow} onOk={handleAddCategoryOk} onCancel={() => { setCategoryModalShow(false); }}>
