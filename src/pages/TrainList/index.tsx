...
import { PlusOutlined, UnorderedListOutlined, UploadOutlined } from '@ant-design/icons';
import type { UploadProps } from 'antd';
import { Button, Form, Input, InputNumber, message, Modal, Space, Table, Upload } from 'antd';
...
const TrainList: React.FC = () => {
  ...
  const columns: ColumnsType<DataType> = [
    ...
    },
    {
      ...
      key: 'category',
      width: 90,
      render: (_, record: any) => <span>{record.status || '默认类目'}</span>,
    },
    {
      title: '创建时间',
      dataIndex: 'createdAt',
